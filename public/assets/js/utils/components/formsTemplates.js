...
export const SupplierFormTemplate = (isEdit = false, data = {}) => {
    ...
    const {id, name, address, email, phone} = data
    console.log(data)
    ...
    return `
         <div class="relative bg-white rounded-lg shadow-sm flex flex-col">
                ...
                <form class="p-6 bg-white rounded-lg shadow-md max-w-2xl " id="form">
                    <input type="hidden" name="method" id="method" value="${isEdit ? 'PUT' : 'POST'}">
                    <input type="hidden" name="id" id="id" value="${isEdit ? id : ''}">
                    <!-- Form Header -->
                    ...
                    <!-- Actions -->
                    <div class="flex items-center justify-end space-x-4 pt-4 flex-wrap gap-   ">
...
export const CategoryFormTemplate = (isEdit = false, data = {}) => {
    ...
    return `
        <div class="relative bg-white rounded-lg shadow-sm flex flex-col">
                ...
                <div class="flex items-center justify-between p-4 md:p-4 py-2 border-b rounded-t relative border-gray-200">
                    <div>
                        <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                            <!-- New Category Icon -->
                            <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7h14M3 11h14m-7 4h7"></path>
                            </svg>
                            ${isEdit ? 'Edit Category' : ' Add New Category'}
                        </h2>
                        <p class="text-gray-600 mt-1">${isEdit ? 'Edit category name below' : ' Enter category name below'}</p>
                    </div>
                    <button type="button" id="closeBtn" class="absolute top-2 right-2 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-close>
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                ...
                <form class="p-6 bg-white rounded-lg shadow-md max-w-2xl" id="form">
                    <input type="hidden" name="method" id="method" value="${isEdit ? 'PUT' : 'POST'}">
                    <input type="hidden" name="id" id="method" value="${isEdit ?  id : ''}">
                    ...
                    <div class="grid gap-5 mb-6 grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="col-span-full">
                            <label for="name" class="mb-2 text-sm font-medium text-gray-700 flex items-center gap-1">
                                <!-- New Label Icon -->
                                <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12H8m0 0H4m4 0v8m0-8V4m12 12h-4m0 0H8m4 0v8m0-8V4"></path>
                                </svg>
                                Category Name
                            </label>
                            <div class="relative">
                                ...
                                <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 transition duration-150 ease-in-out" placeholder="Enter category name" value="${isEdit ? name : ''}">
                            </div>
                            <p class="text-red-500 text-xs mt-1 hidden" id="nameError">Name is required.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-4">
                        ...
                        <button type="submit" class="shrink-0 text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center transition duration-150 ease-in-out">
                            <!-- New Submit Icon -->
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 4v6a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h5"></path>
                            </svg>
