    ...
    <div class="bg-white h-11/12 mt-8 rounded-xl border-2 border-gray-200 p-4 pt-2 pb-2">
        <div class=" h-full ">
            ...
            <div class="mt-4 flex">
                ...
                <button type="button" id="add-category-btn"  class="px-5 py-2.5 text-sm font-medium text-white inline-flex   gap-2  ml-auto items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
